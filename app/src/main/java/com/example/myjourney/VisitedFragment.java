...
import com.example.myjourney.data.PlaceHelper;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

public class VisitedFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDbHelper = new PlaceHelper(getActivity());
        placeCursorAdapter =new PlaceCursorAdapter(getActivity(),null);
        listView.setAdapter(placeCursorAdapter);
        LoaderManager.getInstance(this).initLoader(PLACE_LOADER, null, this);
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        return new CursorLoader(getActivity(),
                ...
                new String[]{String.valueOf(PlaceContract.CountryEntry.SITUATION_VISITED)},
                PlaceContract.CountryEntry.COLUMN_DATE+" DESC");
    }
